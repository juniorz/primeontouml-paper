...
% This is valid for EMF 2.3 / MDT OCL 1.1 (from where?)
...
%(the OCL-delegate validator)
%with respect to implement OCL validations. The OCLInEcoreValidator validator is
%one example of delegate-based validator, and I believe CompleteOCLValidator too.
